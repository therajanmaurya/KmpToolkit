 ...
 */
// The legacy opt-in is the POINT of this file: cmp-share graduated to stable, and [ExperimentalShareApi]
...
@file:OptIn(ExperimentalShareApi::class)
...
/**
 * Pins the graduation contract for cmp-share.
 *
 ...
 *  2. Source that still carries the old `@OptIn(ExperimentalShareApi::class)` keeps compiling,
...
class GraduatedApiCompatTest {
    ...
    fun the_stable_surface_is_reachable_without_opting_in() {
        ...
        val caps = platformShareCapabilities
        assertTrue(caps is ShareCapabilities, "the capability descriptor is part of the stable surface")
    }
