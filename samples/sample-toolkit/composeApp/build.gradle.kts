...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            // Compose surface (screens, nav graph, productTicketsModule) moved here in the E4 split —
            // cmp-product-tickets itself is headless now. One line, same as the E2 migration.
            implementation(project(":cmp-product-tickets-compose"))
